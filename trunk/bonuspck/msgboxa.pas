...
{       TL: messages are rewritten in russian           }
{                                                       }
{*******************************************************}
...
begin
  ...
  begin
    ...
    for I := 0 to 3 do
      ...
      begin
        R.Assign(0, 0, 10, 3);
        Control := New(PTVCCButton, Init(R, ButtonName[I], Commands[i],
          bfNormal));
...
begin
  ...
  begin
    ...
    Insert(New(PButton, Init(R, 'Да~л~ьше', cmOk, bfDefault)));
